...
public class StringUtil extends StringUtils {
    ...
    public static List<String> split(CharSequence str, char separator, int limit, boolean isTrim, boolean ignoreEmpty) {
        return (List) (null == str ? new ArrayList(0) : StrSplitter.split(str.toString(), separator, limit, isTrim, ignoreEmpty));
    }
    ...
    public static String[] split(CharSequence str, int len) {
        return null == str ? new String[0] : StrSplitter.splitByLength(str.toString(), len);
    }
    ...
    /**
     * @title 匹配参数字符串，删除最后一位
     * @create 2020年11月10日 19:36:36
     */
    ...
    /**
     * @title 匹配参数字符串，删除最后一位
     * @create 2020年11月10日 19:36:42
     */
    public static String trimStrat(String str, String start) {
    ...
    public static String formatNumber(Integer value, String format) {
        ...
        if (isEmpty(format) || valueStr.length() >= format.length()) {
            return valueStr;
        }
        return org.apache.commons.lang3.StringUtils.substring(format, 0, format.length() - valueStr.length()) + valueStr;
    }
}
